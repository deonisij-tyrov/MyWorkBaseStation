    ...
    <div class="collapse-fluid navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                <a style="color:#e1fcff;" class="nav-link dropdown-toggle " href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
        ...
        <li><a style="color:#e1fcff;" href="${pageContext.request.contextPath}/frontController?command=logout"><span
                class="text">Hi, ${user.name}!!!!!!!local</span></a></li>
        </c:if>
        <c:if test="${empty user}">
            <li><a style="color:#e1fcff;" href="${pageContext.request.contextPath}/frontController?command=login"><span
